...
export const editPageTemplate = (form) => html`<div class="row space-top">
<div class="col-md-12">
...
<div class="row space-top">
    <div class="col-md-4">
        ...
        <div class="form-group has-success">
            ...
            <input class="form-control${form.invalidFields.model ? ' is-invalid' : ' is-valid'}" type="text" name="model" .value=${form.values.model}>
        </div>
